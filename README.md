...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qrtools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12664&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qrtools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qrtools` can be installed with:

```
conda install qrtools
```

It is possible to list all of the versions of `qrtools` available on your platform with:
